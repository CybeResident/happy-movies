  ...
  methods: {
    submit() {
      ...
      if (!this.isLocalPending) {
        ...
        this.localSearchKey.oldKey !== this.localSearchKey.newKey
          ? this.$emit('search-local', this.localSearchVal, this.searchScope)
          : void 0
      }
    },
